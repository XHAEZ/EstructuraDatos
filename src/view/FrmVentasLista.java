 ...
 * @author danny
 */
public class FrmVentasLista extends javax.swing.JDialog {
     ...
     */
    public FrmVentasLista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public FrmVentasLista(java.awt.Frame parent, boolean modal, SucursalController sc) {
        super(parent, modal);
        initComponents();
        this.control = sc;
    ...
    public void cargarTabla(){
        modelo.setDatos(control.getSucursal().getVenta());
    ...
    private void cargarVenta(){
        ...
        if (fila >= 0) {
            try {
                this.control.setVenta(this.control.getSucursal().getVenta().get(fila));
            } catch (EmptyException ex) {
                Logger.getLogger(FrmVentasLista.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmVentasLista dialog = new FrmVentasLista(new javax.swing.JFrame(), true);
